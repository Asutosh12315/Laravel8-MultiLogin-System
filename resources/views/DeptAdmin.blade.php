  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Departmental Admin Details</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      ...
                      <p class="text-muted text-sm"><b>Designation: </b>{{$admin['designation']}}</p>
                      <p class="text-muted text-sm"><b>ShiftTime: </b>{{$admin['shifttime']}}</p>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    ...
                    <a href="/deletedeptadmin/{{$admin['id']}}" class="btn btn-sm btn-danger">
