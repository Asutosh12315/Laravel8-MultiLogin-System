...
<head>
  ...
  <title>Admin Profile | AreaAdmin Profile</title>
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      ...
                      <p class="text-muted text-sm"><b>zone: </b>{{$admin['zone']}}</p>
                      <p class="text-muted text-sm"><b>Department: </b>{{$admin['department']}}</p>
                      <p class="text-muted text-sm"><b>Category: </b>{{$admin['category']}}</p>
                    ...
                    <div class="col-5 text-center">
                      <img src="{{asset('adminasset/dist/img/user1-128x128.jpg')}}" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                  <div class="text-right">
                    ...
                    <a href="/deleteareaadmin/{{$admin['id']}}" class="btn btn-sm btn-danger">
